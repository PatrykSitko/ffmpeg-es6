import fs from "file-system-es6";
import flat from "./polyfills/array-flat.mjs";
...
export default class Ffmpeg {
  ...
  set changeFilePath(inputFilePath) {
    this.inputfile = inputFilePath;
  }
